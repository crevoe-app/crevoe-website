  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full">
        ...
        >
          <div className="grid grid-cols-12 gap-4 pb-4 border-b border-gray-200 mb-4 sm:gap-2">
            <div className="col-span-1 text-sm font-medium text-gray-600 sm:col-span-2 sm:text-xs">S/N</div>
            <div className="col-span-5 text-sm font-medium text-gray-600 sm:col-span-5 sm:text-xs">Name</div>
            <div className="col-span-6 text-sm font-medium text-gray-600 sm:col-span-5 sm:text-xs">Email Address</div>
          </div>

          <div className="space-y-4">
            {userData.map((user, index) => (
              <div key={user.id} className="grid grid-cols-12 gap-4 items-center sm:gap-2">
                <div className="col-span-1 sm:col-span-2">
                  <div className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center sm:w-6 sm:h-6">
                    <span className="text-2xl sm:text-lg">{user.avatar}</span>
                  </div>
                </div>
                <div className="col-span-5 ml-2 sm:col-span-5 sm:ml-1">
