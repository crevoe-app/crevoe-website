      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-12 items-center min-h-[250px] sm:min-h-[300px] lg:min-h-0">
        ...
        >
          ...
          <div className="block lg:hidden relative w-full h-full">
            ...
            <motion.div
              className="absolute bg-white rounded-xl sm:rounded-2xl shadow-2xl w-36 h-24 sm:w-44 sm:h-28 overflow-hidden border-2 sm:border-4 border-blue-200 right-8 top-12"
              variants={{
                initial: { rotate: -15, scale: 0.9 },
                hover: { rotate: -12, scale: 0.95 }
              }}
