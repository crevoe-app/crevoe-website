...
export default function ArticleCard({ article, searchQuery = "" }: ArticleCardProps) {
  ...
  return (
    <article className="group bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg hover:border-gray-300 transition-all duration-300 ease-in-out">
      {/* Featured Image */}
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link
            href={`/blog/${slug}`}
            className="inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-700 transition-colors duration-200 group/button"
          >
            Read Article
            <svg
